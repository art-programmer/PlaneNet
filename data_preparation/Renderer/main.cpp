...
// typedef TriMesh_ArrayKernelT<> Mesh;
  ...
  // if (!IO::read_mesh(mesh, "/home/chenliu/Projects/Data/ScanNet/test/test.ply", ropt)) {
  ...
  // for (Mesh::VertexIter vertex_it = mesh.vertices_begin(); vertex_it != mesh.vertices_end(); vertex_it++) {
  //   Vec3f point = mesh.point(vertex_it.handle());
  //   cout << point.size() << endl;
    
  //   for (int c = 0; c < 3; c++) {
  //     cout << GLfloat(point[c]) << endl;
  //     verticesVec.push_back(GLfloat(point[c]));
  //   }
  //   Vec3uc color = mesh.color(vertex_it);
    
  //   cout << color.size() << endl;

  //   for (int c = 0; c < 3; c++)
  //     //colorsVec.push_back(GLfloat(color[c]));
  //     cout << GLfloat(color[c]) << endl;
  //   //if (vertex_it - mesh.vertices_begin() == 2)
  //   return 0;
  // }
...
int main(int argc, char **argv)
{
  ...
  ply_filename << FLAGS_root_folder << scene_id << "/annotation/planes.ply";
  ...
  if (ply_file.is_open()) {
	...
	//cout << num_vertices << " " << num_faces << endl;
	for (int c = 0; c < 3; c++) {
	  ss >> vertex;
    ...
    //cout << verticesVec.size() << '\t' << colorsVec.size() << '\t' << indicesVec.size() << endl;
  }
  ...
  // for (int c = 0; c < 4; c++) {
  //   for (int d = 0; d < 4; d++)
  //     cout << transformation[d][c] << '\t';
  //   cout << endl;
  // }

  
  // for (int c = 0; c < 10; c++)
  //   cout << verticesVec[c] << endl;
  // for (int c = 0; c < 10; c++)
  //   cout << colorsVec[c] << endl;
  // for (int c = 0; c < 10; c++)
  //   cout << indicesVec[c] << endl;  
  //return 0;
...
void displayCB()
{
    ...
    // glGetFloatv(GL_MATRIX_MODE, test);
    // for (int c = 0; c < 1; c++)
    //   cout << test[c] << endl;    
    // exit(1);
	...
	//filename_ss << FLAGS_root_folder << scene_id << "/annotation/segmentation" + FLAGS_frames_id + "/frame-" << std::setfill('0') << std::setw(6) << frame_index << ".segmentation.png";
	filename_ss << FLAGS_root_folder << scene_id << "/annotation/segmentation" + FLAGS_frames_id + "/" << frame_index << ".png";
	//filename_ss << "test/frame-" << std::setfill('0') << std::setw(6) << frame_index << ".segmentation.png";
	...
	exit(0);
      ...
      double number;
      stringstream filename_ss;
      //filename_ss << FLAGS_root_folder << scene_id << "/frames" << FLAGS_frames_id + "/frame-" << std::setfill('0') << std::setw(6) << frame_index << ".pose.txt";
	...
	transformation[c][3] = 0.0;
      ...
      // for (int c = 0; c < 4; c++)
      // 	cout << transformation[c][0] << ' ' << transformation[c][1] << ' ' << transformation[c][2] << ' ' << transformation[c][3] << endl;
